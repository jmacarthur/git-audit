...
def track_back_to_parents(this_commit, excluded_author, base, depth = 1):
    ...
    for p in this_commit.parents:
        return track_back_to_parents(p, excluded_author, base, depth + 1)
    ...
    try:
        ...
        while True:
            ...
            for p in feature_branches:
                ident = track_back_to_parents(p, merge_author, parents[0])
            commit = parents[0]
